...
* ============================================================ */! function($) {
    ...
    var Typeahead = function(element, options) {
        ...
        this.$menu = $(this.options.menu)
            .insertBefore(this.$element)//.appendTo('body')
    ...
    Typeahead.prototype = {
        ...
        ,
        select: function() {
            var val = JSON.parse(this.$menu.find('.active')
                .attr('data-value')),
                text
            ...
            if (typeof this.onselect == "function") this.onselect(val)
        ...
        ,
        show: function() {
            var pos = $.extend({}, this.$element.parent().offset(), {
                height: this.$element[0].offsetHeight
            })

            this.$menu.css({
                top: pos.top - (this.$menu.outerHeight()),//pos.top + pos.height,
                left: pos.left
            })
        ...
        process: function(results) {
            ...
            if (results.length && typeof results[0] != "string") this.strings = false
