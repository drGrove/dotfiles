...
$(function () {
    ...
    $('#resetButton').click(function() {
        var html = '<div><p>Delete all databases and regenerate them.</p><p class="buttons"><a href="#" class="button">Delete databases</a> ';
        html += '<a href="#" class="button cancel">Cancel</a></p></div>';
    ...
    $('#language').tzSelect({
        selectCallback: function(val) {
            background.setDatabaseLocale(val);
    ...
    $('body').on('click', 'a:first', function () {
        ...
        for (i in tables) {
            background.model.drop(null, true);
        }
