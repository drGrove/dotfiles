...
wallpaper1 = themedir .. "/low-poly-planet-white-blue.png"
wallpaper_base = sharedthemes .. "/default/background.png"

if awful.util.file_readable(wallpaper1) then
  theme.wallpaper = wallpaper1
else
  theme.wallpaper = wallpaper_base
end
-- }}}
