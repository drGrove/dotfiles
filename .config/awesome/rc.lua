...
-- keyboard map indicator and switch
...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, lasklist_buttons)
